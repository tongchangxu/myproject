...
public class ContractVO {
	//租赁合同序号
		...
		public String toString() {
			return "ContractVO [contractId=" + contractId + ", contractNumber=" + contractNumber + ", operator="
					...
					+ ", createTime=" + createTime + ", customerId=" + customerId + ", customerName=" + customerName
					+ ", customerStatus=" + customerStatus + ", customerRemark=" + customerRemark + ", houseId="
					+ houseId + ", houseNumber=" + houseNumber + ", address=" + address + ", space=" + space
					+ ", houseType=" + houseType + ", houseStatus=" + houseStatus + ", area=" + area + ", houseRemark="
					+ houseRemark + ", houseContractCustomerId=" + houseContractCustomerId + "]";
		}
